...
const Navbar = () => {
  ...
  return (
    <div className='flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6'>
        <div className='lg:flex-1 flex-row flex max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px]'>
        ...
        <div className='sm:flex hidden flex-row justify-end gap-4'>
            <CustomButton 
                ...
                />
                <Link to="/profile">
                    <div className='w-[52px] h-[52px] rounded-full bg-black flex justify-center items-center cursor-pointer'>
        ...
        <div className='sm:hidden flex justify-between relative items-center'>
            ...
            />
            <div className={`absolute top-[60px] right-0 left-0 bg-[#1c1c24] z-10 shadow-secondary rounded-[10px] py-4 ${!toggleDrawer ? '-translate-y-[100vh]' : 'translate-y-0'} transition-all duration-700`}>
                <ul className='mb-4'> 
                    {navlinks.map((Link) => (
                        <li
                            key={Link.name}
